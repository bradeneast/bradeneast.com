if (document.querySelector('footer')) {
    ...
    <section class="section cta">
        <div class="section__body limited-width center" data-scroll>
            <h3 class="pad center">
                ...
                <br>&nbsp;<br>
                <a class="cta__link" href="mailto:bradeneastdesign@gmail.com">braden<wbr>east<wbr>design<wbr>@gmail.com</a>
            </h3>
        </div>
    </section>
    `);
    ...
    <div class="body-image center circle" style="width: 20rem; max-width: 80vw;">
        <img src="/images/witchita-peak.jpg" alt="Exploring the Witchita Mountains | Shot by my beautiful bride" />
    </div>
    <br>
