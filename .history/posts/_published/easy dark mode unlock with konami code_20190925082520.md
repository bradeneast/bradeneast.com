...
P.S. Thanks to [Chris Ferdinandi](https://gomakethings.com) for the concise key handler logic!

P.P.S. <button onclick="() => { localStorage.setItem(`darkModeOn`, darkModeOn); document.body.classList.toggle(`dm`)}">Don't CLick Me</button>