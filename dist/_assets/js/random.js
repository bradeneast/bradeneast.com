...
}; function f() { return fetch("/sitemap.xml").then(function (a) { return a.text(); }).then(function (a) { return new DOMParser().parseFromString(a, "text/xml"); }); } var g = [], i = ["/blog/.+"]; setTimeout(function () { return b(".hidden").forEach(function (a) { return a.classList.remove("hidden"); }); }, 1000); f().then(function (a) {
    var e_1, _a;
    try {
